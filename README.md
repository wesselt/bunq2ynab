...
Bunq2Ynab is a Python script that synchronizes [bunq](https://bunq.com) accounts with [YNAB](https://youneedabudget.com) accounts.  Since January 2025 YNAB supports bunq as a linked account through Plaid.  You can use this script for fun or because it syncs instantly.
